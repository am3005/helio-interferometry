...
class dlite_npol(gr.top_block):
    ...
    def __init__(self):
        ...
        #Needed for anti-squelch
        self.analog_simple_squelch_1x = analog.simple_squelch_cc(THRESH[0], 1)
        self.analog_simple_squelch_1y = analog.simple_squelch_cc(THRESH[1], 1)
        self.analog_simple_squelch_2x = analog.simple_squelch_cc(THRESH[2], 1)
        self.analog_simple_squelch_2y = analog.simple_squelch_cc(THRESH[3], 1)
        self.analog_simple_squelch_3x = analog.simple_squelch_cc(THRESH[4], 1)
        self.analog_simple_squelch_3y = analog.simple_squelch_cc(THRESH[5], 1)
        self.analog_simple_squelch_4x = analog.simple_squelch_cc(THRESH[6], 1)
        self.analog_simple_squelch_4y = analog.simple_squelch_cc(THRESH[7], 1)
        self.blocks_sub_1x = blocks.sub_cc(1)
        self.blocks_sub_1y = blocks.sub_cc(1)
        self.blocks_sub_2x = blocks.sub_cc(1)
        self.blocks_sub_2y = blocks.sub_cc(1)
        self.blocks_sub_3x = blocks.sub_cc(1)
        self.blocks_sub_3y = blocks.sub_cc(1)
        self.blocks_sub_4x = blocks.sub_cc(1)
        self.blocks_sub_4y = blocks.sub_cc(1)
        #
        ...
        #implement ant-sqelch
        #1-X
        self.connect((self.uhd_usrp_source_0, 0), (self.analog_simple_squelch_1x, 0))
        self.connect((self.uhd_usrp_source_0, 0), (self.blocks_sub_1x, 0))
        self.connect((self.analog_simple_squelch_1x, 0), (self.blocks_sub_1x, 1))
        self.connect((self.blocks_sub_1x, 0), (self.blocks_stream_to_vector_1x, 0))
        #1-Y
        self.connect((self.uhd_usrp_source_0, 1), (self.analog_simple_squelch_1y, 0))
        self.connect((self.uhd_usrp_source_0, 1), (self.blocks_sub_1y, 0))
        self.connect((self.analog_simple_squelch_1y, 0), (self.blocks_sub_1y, 1))
        self.connect((self.blocks_sub_1y, 0), (self.blocks_stream_to_vector_1y, 0))
        #2-X
        self.connect((self.uhd_usrp_source_0, 2), (self.analog_simple_squelch_2x, 0))
        self.connect((self.uhd_usrp_source_0, 2), (self.blocks_sub_2x, 0))
        self.connect((self.analog_simple_squelch_2x, 0), (self.blocks_sub_2x, 1))
        self.connect((self.blocks_sub_2x, 0), (self.blocks_stream_to_vector_2x, 0))
        #2-Y
        self.connect((self.uhd_usrp_source_0, 3), (self.analog_simple_squelch_2y, 0))
        self.connect((self.uhd_usrp_source_0, 3), (self.blocks_sub_2y, 0))
        self.connect((self.analog_simple_squelch_2y, 0), (self.blocks_sub_2y, 1))
        self.connect((self.blocks_sub_2y, 0), (self.blocks_stream_to_vector_2y, 0))
        #3-X
        self.connect((self.uhd_usrp_source_0, 4), (self.analog_simple_squelch_3x, 0))
        self.connect((self.uhd_usrp_source_0, 4), (self.blocks_sub_3x, 0))
        self.connect((self.analog_simple_squelch_3x, 0), (self.blocks_sub_3x, 1))
        self.connect((self.blocks_sub_3x, 0), (self.blocks_stream_to_vector_3x, 0))
        #3-Y
        self.connect((self.uhd_usrp_source_0, 5), (self.analog_simple_squelch_3y, 0))
        self.connect((self.uhd_usrp_source_0, 5), (self.blocks_sub_3y, 0))
        self.connect((self.analog_simple_squelch_3y, 0), (self.blocks_sub_3y, 1))
        self.connect((self.blocks_sub_3y, 0), (self.blocks_stream_to_vector_3y, 0))
        #4-X
        self.connect((self.uhd_usrp_source_0, 6), (self.analog_simple_squelch_4x, 0))
        self.connect((self.uhd_usrp_source_0, 6), (self.blocks_sub_4x, 0))
        self.connect((self.analog_simple_squelch_4x, 0), (self.blocks_sub_4x, 1))
        self.connect((self.blocks_sub_4x, 0), (self.blocks_stream_to_vector_4x, 0))
        #4-Y
        self.connect((self.uhd_usrp_source_0, 7), (self.analog_simple_squelch_4y, 0))
        self.connect((self.uhd_usrp_source_0, 7), (self.blocks_sub_4y, 0))
        self.connect((self.analog_simple_squelch_4y, 0), (self.blocks_sub_4y, 1))
        self.connect((self.blocks_sub_4y, 0), (self.blocks_stream_to_vector_4y, 0))
        #
